...
public record SectionContent(String title, List<LessonContent> lessons) {
    public static List<SectionContent> from(Curriculum curriculum) {
        return curriculum.getSections()
                .stream()
                .map(section -> new SectionContent(
                        section.getTitle(),
                        section.getLessons()
                                .stream()
    ...
    public static SectionContent section(String title, LessonContent... LessonContent) {
        return new SectionContent(title, List.of(LessonContent));
    }
}
