...
@AnalyzeClasses(packages = "com.errday.splearn", importOptions = ImportOption.DoNotIncludeTests.class)
public class HexagonalArchitectureTest {
    ...
    void hexagonalArchitecture(JavaClasses classes) {
        Architectures.layeredArchitecture()
                ...
                .layer("domain").definedBy("com.errday.splearn.domain..")
                .layer("application").definedBy("com.errday.splearn.application..")
                .layer("adapter").definedBy("com.errday.splearn.adapter..")
    ...
    void aggregateFreeOfCycles(JavaClasses classes) {
        SlicesRuleDefinition.slices()
                .matching("com.errday.splearn.domain.(*)..")
    ...
    void applicationServiceFreeOfCycles(JavaClasses classes) {
        SlicesRuleDefinition.slices()
                .matching("com.errday.splearn.application.(*)..")
                .should().beFreeOfCycles()
                .check(classes);
    }
